    ...
    <div>
      ...
      <div className=" flex flex-cols sm:flex-row items-start gap-5 mt-5">
        <div className="flex flex-col gap-4 text-gray-600 text-sm">
          ...
          <p onClick={()=>speciality==='Gastrologist'?navigate('/doctors'):navigate('/doctors/Gastrologist')} className={`w-[94vw] sm:w-auto pl-3 py-1.5 pr-16 border border-gray-300 rounded transition-all cursor-pointer`}>Gastrologist</p>
        </div>
